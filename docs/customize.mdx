...
To customize the CSS utilities, you can import LowCSS into your project and modify the SASS variables that it exports:
...
Read more in the [SASS variables](./variables) section.
