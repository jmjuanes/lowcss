...
The theme variables allows you to configure the values for the utilities. It allows you to define colors, spacing, fonts, and other theme-related settings. Modify the values of those variables to match your project's design system.
...
This is the list of available theme variables that are allowed for customizing utilities values:
...
- `low.reset()`: this mixin injects the CSS reset styles. Read more in the [Reset CSS](./reset.html) section.
- `low.forms()`: this mixin injects a simple reset for the most common form elements.
